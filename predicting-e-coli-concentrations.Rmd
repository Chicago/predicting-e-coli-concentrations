...
knitr::kable(modelCompData, format = "pandoc", caption = "Comparing Specificity, Sensitivity, Accuracy, Area Under Curve (AUC), and Matthews Correlation Coefficient (MCC) between Hybrid and Prior-day Nowcast models.")
```
