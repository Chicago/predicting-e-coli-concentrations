...
![Variable Importance Plot.](img/importance-plot.png)
...
Over the summer, the analytical model had a true positive rate of 11.2 percent compared to a true positive rate of 3.2 percent in 2016 (Table 4). From 2015 through 2016, the historical average true positive rate for those beaches was 3.3 percent. That is, the hybrid model increased the true positive rate by 250 percent over the historical average. 
...
Table 4: Comparing specificity, sensitivity, and accuracy between Hybrid and Prior-day Nowcast Models.
