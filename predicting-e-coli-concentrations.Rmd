...
csl: bibliography/water-research.csl
---
...
```{r correlation_heatmap, echo=FALSE, fig.width=17, fig.height=10, fig.align='center', fig.cap='Correlation heat map of Chicago beaches', results='hide', message=FALSE, warning=FALSE}
