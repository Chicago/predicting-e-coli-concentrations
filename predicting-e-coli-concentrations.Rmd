...
We select one beach, $\hat{x}_i^t$, in each cluster to be the feature beach for predicting the bacteria levels for the remaining $m$ beaches in the cluster, $x_i^t$. Thus, each cluster ($k$) will have the following membership: $K_i: \{ \hat{x}_1^t, x_1^t, x_2^t, \dots, x_m^t \}$.
...
To translate the predicted E. coli level to an advisory decision, the threshold level referenced in Section 2.6 was used (381 CFU/100ml).
